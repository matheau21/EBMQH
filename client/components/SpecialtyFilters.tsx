...
const specialtyConfig = [
  ...
  },
  {
    ...
    activeColor:
      "bg-specialty-endocrinology/30 text-specialty-endocrinology dark:bg-specialty-endocrinology/20 dark:text-specialty-endocrinology border-specialty-endocrinology/50 ring-1 ring-specialty-endocrinology/40",
  },
  {
  ...
  },
  {
    ...
    activeColor:
      "bg-specialty-infectious/30 text-specialty-infectious dark:bg-specialty-infectious/20 dark:text-specialty-infectious border-specialty-infectious/50 ring-1 ring-specialty-infectious/40",
  },
  {
    name: "Rheumatology",
    ...
    activeColor:
      "bg-specialty-rheumatology/30 text-specialty-rheumatology dark:bg-specialty-rheumatology/20 dark:text-specialty-rheumatology border-specialty-rheumatology/50 ring-1 ring-specialty-rheumatology/40",
  },
  {
    name: "Nephrology",
    ...
    activeColor:
      "bg-specialty-nephrology/30 text-specialty-nephrology dark:bg-specialty-nephrology/20 dark:text-specialty-nephrology border-specialty-nephrology/50 ring-1 ring-specialty-nephrology/40",
  },
  {
    ...
    activeColor:
      "bg-specialty-gastroenterology/30 text-specialty-gastroenterology dark:bg-specialty-gastroenterology/20 dark:text-specialty-gastroenterology border-specialty-gastroenterology/50 ring-1 ring-specialty-gastroenterology/40",
  },
  {
    name: "Neurology",
